...
public class EnterpriseSecurityRuntimeException extends java.lang.RuntimeException {
    ...
    /** The logger. */
    protected final Logger logger = LoggerFactory.getLogger(EnterpriseSecurityRuntimeException.class);
    ...
    public EnterpriseSecurityRuntimeException(String userMessage, String logMessage) {
        ...
        if (!SecurityHandler.securityConfiguration().getDisableIntrusionDetection()) {
        	SecurityHandler.intrusionDetector().addException(this);
        }
    }
