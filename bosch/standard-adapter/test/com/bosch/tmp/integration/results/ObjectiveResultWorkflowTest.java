...
/**
 * Test class to assert Objective Result work-flow for ORU_R30 request.
 * @author BEA2KOR
 *
 */
public class ObjectiveResultWorkflowTest
{
	//Test Data file locations..
	private static final String TEST_INPUT_QVR_Q17 = "test/data/results/objective/QVR_Q17.xml";
	private static final String TEST_OUTPUT_FIND_RESULTS_REPLY = "test/data/results/objective/FindResults.xml";
	private static final String TEST_OUTPUT_FIND_ADHOC_RESULTS_REPLY = "test/data/results/objective/FindAdhocResults.xml";
	...
	/**
	 * Process QVR_Q17 request for ORU_R30 response type (Only Objective results)..
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Process QVR_Q17 request for ORU_R01 response type (Only Objective results)..
	 * @throws Exception
	 */
	@Test
