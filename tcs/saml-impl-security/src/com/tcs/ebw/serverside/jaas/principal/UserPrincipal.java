...
public class UserPrincipal extends EBWTransferObject implements Principal, java.io.Serializable, Cloneable{
        ...
        */
		...
		public String toString()
		{
		    ...
		    retValue = "UserPrincipal ( "
		        + super.toString() + TAB
		        + "fanums = " + this.fanums + TAB
		        + "name = " + this.name + TAB
		        + "usrusername = " + this.usrusername + TAB
		        + "usrgrpid = " + this.usrgrpid + TAB
		        + "usruserid = " + this.usruserid + TAB
		        + "usrchnl = " + this.usrchnl + TAB
		        + "usrapplsys = " + this.usrapplsys + TAB
		        + "usrsigntype = " + this.usrsigntype + TAB
		        + "usrbrcode = " + this.usrbrcode + TAB
		        + "usrremarks = " + this.usrremarks + TAB
		        + "usremail = " + this.usremail + TAB
		        + "usrmobileno = " + this.usrmobileno + TAB
		        + "usrpagerno = " + this.usrpagerno + TAB
		        + "usrfaxno = " + this.usrfaxno + TAB
		        ...
		        + "usrstatus = " + this.usrstatus + TAB
		        + "usrapprovedby = " + this.usrapprovedby + TAB
		        + "usrtimestamp = " + this.usrtimestamp + TAB
		        + "usrsecuritymedia = " + this.usrsecuritymedia + TAB
		        + "intstatus = " + this.intstatus + TAB
		        + "usrissuerdn = " + this.usrissuerdn + TAB
		        + "usrsubjectdn = " + this.usrsubjectdn + TAB
		        + "usrcheckerdn = " + this.usrcheckerdn + TAB
		        + "usrmakerdn = " + this.usrmakerdn + TAB
		        + "usrdnstatus = " + this.usrdnstatus + TAB
		        + "firstauthorisedby = " + this.firstauthorisedby + TAB
		        + "firstauthoriseddate = " + this.firstauthoriseddate + TAB
		        + "usrroleid = " + this.usrroleid + TAB
		        + "retlcustid = " + this.retlcustid + TAB
		        + "usertype = " + this.usertype + TAB
		        + "custid = " + this.custid + TAB
		        + "usertitle = " + this.usertitle + TAB
		        + "middlename = " + this.middlename + TAB
		        + "lastname = " + this.lastname + TAB
		        + "basebank = " + this.basebank + TAB
		        + "basebranch = " + this.basebranch + TAB
		        + "roletype = " + this.roletype + TAB
		        + "validfrom = " + this.validfrom + TAB
		        + "validto = " + this.validto + TAB
		        + "dateofbirth = " + this.dateofbirth + TAB
		        + "taxid = " + this.taxid + TAB
		        + "workphno = " + this.workphno + TAB
		        + "mobileno = " + this.mobileno + TAB
		        + "homephno = " + this.homephno + TAB
		        + "faxno = " + this.faxno + TAB
		        + "email = " + this.email + TAB
		        + "resstreet = " + this.resstreet + TAB
		        + "ressuburb = " + this.ressuburb + TAB
		        + "rsestate = " + this.rsestate + TAB
		        + "respostcode = " + this.respostcode + TAB
		        + "pastreet = " + this.pastreet + TAB
		        + "pasuburb = " + this.pasuburb + TAB
		        + "pastate = " + this.pastate + TAB
		        + "papostcode = " + this.papostcode + TAB
		        + "workphcode = " + this.workphcode + TAB
		        + "homephcode = " + this.homephcode + TAB
		        + "faxcode = " + this.faxcode + TAB
		        + "authorisedby = " + this.authorisedby + TAB
		        + "authoriseddate = " + this.authoriseddate + TAB
		        + "validatedby = " + this.validatedby + TAB
		        + "validateddate = " + this.validateddate + TAB
		        + "userFap = " + this.userFap + TAB
		        + "userMenuFap = " + this.userMenuFap + TAB
		        + "userDap = " + this.userDap + TAB
		        + "transPassword = " + this.transPassword + TAB
		        + "sessionId = " + this.sessionId + TAB
		        + "usrtranspwd = " + this.usrtranspwd + TAB
		        + "usrlongname = " + this.usrlongname + TAB
		        + "ipAddr = " + this.ipAddr + TAB
		        + "usracctids = " + this.usracctids + TAB
		        + "usracctid = " + this.usracctid + TAB
		        + "usrpwd = " + this.usrpwd + TAB
		        + "fanum = " + this.fanum + TAB
		        + "cgrgrpname1 = " + this.cgrgrpname1 + TAB
		        + "extuserid = " + this.extuserid + TAB
		        + "extsessionid = " + this.extsessionid + TAB
		        + "langCode = " + this.langCode + TAB
		        + "countryCode = " + this.countryCode + TAB
		        + "terminalId = " + this.terminalId + TAB
		        + "digitSeparator = " + this.digitSeparator + TAB
		        + "decimalPresentation = " + this.decimalPresentation + TAB
		        + "numberFormat = " + this.numberFormat + TAB
		        + "decimalPrecision = " + this.decimalPrecision + TAB
		        + "applContext = " + this.applContext + TAB
		        + "signtype = " + this.signtype + TAB
		        + "MMSAMLAssertion = " + this.MMSAMLAssertion + TAB
		        + "rtabOutputDetails = " + this.rtabOutputDetails + TAB
		        + "merlinOutputDetails = " + this.merlinOutputDetails + TAB
		        + "toAccMerlinOutputDetails = " + this.toAccMerlinOutputDetails + TAB
		        + "minrange = " + this.minrange + TAB
		        + "maxrange = " + this.maxrange + TAB
		        + "contextData = " + this.contextData + TAB
		        + "brErrorMessages = " + this.brErrorMessages + TAB
		        + "uuid = " + this.uuid + TAB
