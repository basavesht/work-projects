...
public class MSCommonUtils {
	...
	/**
	 * Gets the spoke to collections object..
	 * @return
	 * @throws Exception 
	 */
	...
	public static String getExpiryPeriodParams(String transferType,ServiceContext context) throws Exception
	{
		...
		try 
		{
			...
			else if(transferType!=null && (transferType.startsWith(TxnTypeCode.INTERNAL) || transferType.startsWith(TxnTypeCode.ACH_TYPE))){
	...
	public static String getMaxFutureDaysParams(String transferType,ServiceContext context) throws Exception
	{
		...
		try 
		{
			...
			else if(transferType!=null && transferType.startsWith(TxnTypeCode.INTERNAL)){
	 ...
	 * @throws Exception
	 */
	public static Date calculateStartBusinessDate(String repeatValue,Date estArrivalDateVal,String transferType) throws Exception 
	{
