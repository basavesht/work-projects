...
public class SetNotificationInput
{
	...
	public static void setNotificationTxnInputDetails(String notificationId,HashMap txnDetails,Boolean isExternalAcc,ServiceContext serviceContext) throws Exception
	{
		...
		try 
		{
			...
			//Setting the ExternalAccount Flag.
			...
			if(!isExternalAcc) 
			{
				...
				objNotificationOut.setLifeTimeUserId(objPaymentDetails.getLife_user_id());
			...
			else  
			{
				...
				setNotifyAttrEventFlag(notificationId,objNotificationInDetails);
				objNotificationOut.setExternalAccount(MSCommonUtils.formatExtAcc_Notify_INIT(objExternalAccDetails));
				objNotificationOut.setAccountOwnerMSSB(objExternalAccDetails.getAccount_owner());
				objNotificationOut.setPrimaryAccount(objExternalAccDetails.getPrimaryAccount());
				objNotificationOut.setBankName(objExternalAccDetails.getCpyboname1());
	...
	public static void setNotifyAttrEventFlag(String notificationId,NotificationInDetails objNotificationInDetails) throws Exception
	{
		try 
		{
			...
			List<String> sendFrequency = new ArrayList<String>(Arrays.asList("NOTIFY_P8","NOTIFY_P10","NOTIFY_P12","NOTIFY_P20","NOTIFY_P22","NOTIFY_P24","NOTIFY_P31","NOTIFY_P18","NOTIFY_P33","NOTIFY_P35"));
			List<String> sendUntilValue = new ArrayList<String>(Arrays.asList("NOTIFY_P8","NOTIFY_P10","NOTIFY_P20","NOTIFY_P22","NOTIFY_P31","NOTIFY_P33"));
			List<String> sendSkippedTransferDate = new ArrayList<String>(Arrays.asList("NOTIFY_P13","NOTIFY_P25","NOTIFY_P36"));
			List<String> sendNextTransferDate = new ArrayList<String>(Arrays.asList("NOTIFY_P13","NOTIFY_P25","NOTIFY_P36"));
			List<String> sendAccountInitDate = new ArrayList<String>(Arrays.asList("NOTIFY_P3"));
			List<String> sendAccountSuspendDate = new ArrayList<String>(Arrays.asList("NOTIFY_P4","NOTIFY_P40"));
			...
			List<String> sendAccountOwnerMSSB = new ArrayList<String>(Arrays.asList("NOTIFY_P4","NOTIFY_P40"));
			List<String> sendPrimaryAccount = new ArrayList<String>(Arrays.asList("NOTIFY_P4","NOTIFY_P40"));
			List<String> sendBankName = new ArrayList<String>(Arrays.asList("NOTIFY_P4","NOTIFY_P40"));
			...
			//Setting the AccountOwner MSSB value.
			if(sendAccountOwnerMSSB.contains(notificationId)){
				objNotificationInDetails.setAccountOwnerMSSB(true);
			}
			//Setting the Bank Name value.
			if(sendBankName.contains(notificationId)){
				objNotificationInDetails.setBankName(true);
			}
			//Setting the Primary Account value.
			if(sendPrimaryAccount.contains(notificationId)){
				objNotificationInDetails.setPrimaryAccount(true);
			}
		}
		catch(Exception exception){
			throw exception;
