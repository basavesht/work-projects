 ...
 * **********************************************************
 */
public class PostRejectConfirmForm extends EbwForm implements java.io.Serializable {

	/**
	 * Form Bean Constructor. 
	 */ 
	public PostRejectConfirmForm () {
		try {
			setState("PostRejectConfirm_INIT");
	...
	public void copyCollections(PostRejectConfirmForm srcForm) {
	}
	...
	public Vector getReportInformation(){
		...
		Object[][] objArr = {{"PostRejectConfirm", "ScreenName"}};
