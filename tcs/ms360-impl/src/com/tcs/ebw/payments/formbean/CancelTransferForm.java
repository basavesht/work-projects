/*
 * Created on Thu Apr 16 20:15:38 IST 2009
 *
 ...
 * **********************************************************
 */
public class CancelTransferForm extends EbwForm implements java.io.Serializable {

	/**
	 * Form Bean Constructor. 
	 */ 
	public CancelTransferForm () {
		try {
			setState("CancelTransfer_INIT");
	...
	public void copyCollections(CancelTransferForm srcForm) {
	}
	...
	public Vector getReportInformation(){
		...
		Object[][] objArr = {{"CancelTransfer", "ScreenName"}};
	...
	/**
	 * @param brErrors the brErrors to set
	 */
	...
	public String toString()
	{
		...
		retValue = "CancelTransferForm ( "
			...
			+ "threasholdAmount = " + this.threasholdAmount + TAB
			+ "screenNavigationFlag = " + this.screenNavigationFlag + TAB
			+ "parentTxnDate = " + this.parentTxnDate + TAB
			+ "brErrors = " + this.brErrors + TAB
			+ " )";
