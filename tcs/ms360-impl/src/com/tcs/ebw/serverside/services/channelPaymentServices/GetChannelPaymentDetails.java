...
public class GetChannelPaymentDetails extends DatabaseService
{
	...
	{	
		try 
		{
			...
			objPaymentDetails.setDisplay_qualifier(currentTxnPaymentTO.getDisplay_qualifier());
	...
	{	
		try 
		{
			...
			objPaymentDetails.setScreen_Type(currentTxnPaymentTO.getPaytypecode());
			objPaymentDetails.setExtAccount_RefId(currentTxnPaymentTO.getPaypayeeaccnum()); //External reference Id in case of ACH-IN and ACH-OUT...
	...
	public void setMSAccountDetails(HashMap txnDetails,DsPayTxnsTO currentTxnPaymentTO)
	{
		...
		if(!objPaymentDetails.isFrmAcc_InContext() && (transfer_Type!=null && (transfer_Type.equalsIgnoreCase(TxnTypeCode.ACH_WITHDRAWAL) || transfer_Type.equalsIgnoreCase(TxnTypeCode.INTERNAL) || transfer_Type.startsWith(ChkReqConstants.CHK) || transfer_Type.startsWith(TxnTypeCode.PORTFOLIO_LOAN))))
		{
