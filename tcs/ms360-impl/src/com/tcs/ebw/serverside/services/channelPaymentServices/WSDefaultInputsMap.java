...
public class WSDefaultInputsMap extends DatabaseService 
{
	...
	/**
	 * MS360 Max Future Days for Verbal Authorization Date..
	 * @param serviceContext
	 * @return
	 * @throws Exception
	 */
	public static String getMaxPastVerbalAuthDays(ServiceContext serviceContext) throws Exception
	{
		String PastDaysId = "";
		Object objPastDaysId = null; 
		ArrayList<Object> objPastDaysVal = new ArrayList<Object>();
		Boolean isDirectDBCall = true;
		try
		{
			CacheObject cacheObj = new CacheObject();
			objPastDaysId = cacheObj.getCacheData("getMaxPastDtsVerbalAuth",isDirectDBCall,serviceContext);
			if(objPastDaysId!=null)
			{
				objPastDaysVal = (ArrayList<Object>) objPastDaysId;
				if (!objPastDaysVal.isEmpty() && objPastDaysVal.get(1)!= null){
					PastDaysId = (String)(((ArrayList)objPastDaysVal.get(1)).get(0));
				}
			}
			EBWLogger.logDebug("WSDefaultInputsMap","MS360 Max Past Days for Verbal Auth Days."+ PastDaysId);
		} 
		catch (Exception exception) {
			throw exception;
		}
	 ...
	 * @throws Exception
	 */
	public static String getPLAAppID(ServiceContext serviceContext) throws Exception
	{
		String appId = "";
		Object objAppId = null; 
		ArrayList<Object> appIdVal = new ArrayList<Object>();
	 ...
	 * @throws Exception
	 */
	public static String getPLARequestHost(ServiceContext serviceContext) throws Exception
	{
		String serverIp = "";
		Object objServerIp = null; 
		ArrayList<Object> serverIdVal = new ArrayList<Object>();
	 ...
	 * @throws Exception
	 */
	public static String getPLATxnCutOffTime(ServiceContext serviceContext) throws Exception
	{
		String cutOffTimeId = "";
		Object objCutOffTimeId = null; 
		ArrayList<Object> objCutOffTimeVal = new ArrayList<Object>();
	 ...
	 * @throws Exception
	 */
	public static String getPLAUserID(ServiceContext serviceContext) throws Exception
	{
		String userId = "";
		Object objUserId = null; 
		ArrayList<Object> userIdVal = new ArrayList<Object>();
