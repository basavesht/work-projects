...
public class RTABInterfaceIn{
	...
	public static Vector setRTABInputDetails(HashMap txnDetails,ServiceContext serviceContext) throws Exception
	{
		...
		try 
		{
			...
			objMS_RTAB_INPUTTO.setUSER_ID(objMSUserDetails.getLoginId());
			objMS_RTAB_INPUTTO.setAPPL_ID(WSDefaultInputsMap.getRTABAppID(new Boolean(true),serviceContext));
