...
public class MerlinInterfaceIn {
	...
	public static Vector setMerlinInputDetails(HashMap txnDetails,ServiceContext serviceContext) throws Exception 
	{
		...
		try
		{
			...
			objFromMS_MERLIN_INPUT.setAPPL_ID(WSDefaultInputsMap.getAcntViewAppID(new Boolean(true),serviceContext));
			objFromMS_MERLIN_INPUT.setAUTH_APPL_ID(WSDefaultInputsMap.getAcntViewAuthAppID(new Boolean(true),serviceContext));
			objFromMS_MERLIN_INPUT.setAUTH_VERB(WSDefaultInputsMap.getAcntViewAuthVerb(new Boolean(true),serviceContext));
			objFromMS_MERLIN_INPUT.setUSER_ID(WSDefaultInputsMap.getAcntViewUserID(new Boolean(true),serviceContext));
			objFromMS_MERLIN_INPUT.setWEB_SERVER_ID(WSDefaultInputsMap.getAcntViewWebServerID(new Boolean(true),serviceContext));
			...
			objToMS_MERLIN_INPUT.setAPPL_ID(WSDefaultInputsMap.getAcntViewAppID(new Boolean(true),serviceContext));
			objToMS_MERLIN_INPUT.setAUTH_APPL_ID(WSDefaultInputsMap.getAcntViewAuthAppID(new Boolean(true),serviceContext));
			objToMS_MERLIN_INPUT.setAUTH_VERB(WSDefaultInputsMap.getAcntViewAuthVerb(new Boolean(true),serviceContext));
			objToMS_MERLIN_INPUT.setUSER_ID(WSDefaultInputsMap.getAcntViewUserID(new Boolean(true),serviceContext));
			objToMS_MERLIN_INPUT.setWEB_SERVER_ID(WSDefaultInputsMap.getAcntViewWebServerID(new Boolean(true),serviceContext));
