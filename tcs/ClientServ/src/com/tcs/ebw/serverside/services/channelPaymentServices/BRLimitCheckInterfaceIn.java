...
public class BRLimitCheckInterfaceIn {
	...
	/** 
	 * The method is used for setting the limit check parameters while limit invocation....
	 * @param toObjects
	 * @return
	 * @throws Exception 
	 */
	...
	public static Vector setLimitParameters(HashMap txnDetails,ServiceContext serviceContext) throws Exception 
	{
		...
		try 
		{
			...
			//Mapping the BR Txn input details..
			...
			objBUS_RULE_INP_CRTL.setUSER_ID(objMSUserDetails.getLoginId());
			objBUS_RULE_INP_CRTL.setGROUP(objPaymentDetails.getCurrent_owner_role()); //Needs to be changed according to the Context XML.
