...
public class PaymentDetailsTO implements Serializable {
	...
	boolean isFrmAcc_InContext=false; // Checks if the From Key account no is in the context . True : present False : Not present 
	boolean isToAcc_InContext=false;  // Checks if the From Key account no is in the context . True : present False : Not present 
	...
	private String prevAction = null; //Values: Create/Modify/Cancel    //For DAP Check only Delegate
	private String statusChkId = null;//Values : TXNSTATUS/ACNTSTATUS  //Delegate..
	private String statusChkEventDesc = null;
	private boolean isStatusChkReq = false;
	...
	//9. Transaction owner and initiator details...
	...
	private String current_approver_role =null;//Current Approver role..
	...
	private String created_by_comments =null; //Stores the comments of transaction..
	private String previous_owner_role = null; //Previous Owner Role..

	//10. Txn_Parent attributes mapping for checking the recurring criteria, will be updated on update_txn_parent execute...
	...
	private Double  rta_Action_Key_Fee = null; //RTA action key..
	...
	private boolean cancelRTAFlag = false; //Reserve RTA flag...
