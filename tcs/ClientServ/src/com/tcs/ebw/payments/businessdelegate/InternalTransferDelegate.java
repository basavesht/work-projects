...
public class InternalTransferDelegate extends EbwBusinessDelegate {
	...
	public InternalTransferForm internalTransfer_INIT_iNIT() throws Exception
	{
		...
		IEBWService objService = EBWServiceFactory.create("getOnLoadInternalINITDtl",appContext);
		...
		objInternalTransferForm.setBusinessDate(ConvertionUtil.convertToString(dsConfigDetailsOut.getBusiness_date()));
		objInternalTransferForm.setInitiationDate(ConvertionUtil.convertToString(dsConfigDetailsOut.getBusiness_date()));
	...
	public InternalPreConfirmForm internalTransfer_INIT_submitbut() throws Exception 
	{
		...
		IEBWService objService = EBWServiceFactory.create("checkPaymentDetails",appContext);
		objOutput = objService.execute(clsParamTypes, objParams);
	...
	public InternalTransferForm internalTransfer_Edit_iNIT() throws Exception {
		...
		IEBWService objService = EBWServiceFactory.create("getOnLoadInternalEditDtl",appContext);
		objOutput = objService.execute(clsParamTypes, objParams);
		...
		objInternalTransferForm.setInitiationDate(ConvertionUtil.convertToString(dsGetEditTransferOutTO.getInitiationDate()));
