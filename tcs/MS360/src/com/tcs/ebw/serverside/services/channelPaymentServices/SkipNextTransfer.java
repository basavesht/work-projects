	...
	public void skipNextTransfer(int statusFlag,HashMap txnDetails,ServiceContext serviceContext) throws Exception 
	{
		...
		try
		{
			...
			if(objPaymentDetails.getPrefered_next_txn_dt()!=null) {
				nextBusinessDate = MSCommonUtils.evaluateNextTxnDate(frequencyValue,objPaymentDetails.getPrefered_next_txn_dt(),parentTxnDate,transferType,serviceContext);
				...
				nextBusinessDate = MSCommonUtils.evaluateNextTxnDate(frequencyValue,objPaymentDetails.getNext_txn_dt(),parentTxnDate,transferType,serviceContext);
