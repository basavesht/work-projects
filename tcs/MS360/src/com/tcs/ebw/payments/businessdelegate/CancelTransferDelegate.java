...
public class CancelTransferDelegate extends EbwBusinessDelegate {
	...
	public CancelTransferForm cancelTransfer_INIT_iNIT() throws Exception 
	{
		...
		//Service Call.....
		IEBWService objService = EBWServiceFactory.create("getOnLoadCancelPayDetails");
		...
		objCancelTransferForm.setBusinessDate(ConvertionUtil.convertToAppDateStr(dsConfigDetailsOut.getBusiness_date()));
		...
		objCancelTransferForm.setCancelTransTransferDate (ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getRequested_exe_dt()));
		objCancelTransferForm.setCancelTransEntryDate(ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getCreated_date()));
	...
	public CancelTransferConfirmForm cancelTransfer_INIT_cancelBtn() throws Exception 
	{
		...
		//Service Call.....
		IEBWService objService = EBWServiceFactory.create("cancelPaymentDetails");
		objOutput = objService.execute(clsParamTypes, objParams);
	...
	public CancelTransferForm cancelTransfer_Recurring_iNIT() throws Exception 
	{
		...
		objCancelTransferForm.setCancelTransAmount (MSCommonUtils.formatTxnAmount(dsgetCancelPayOutTO.getPaydebitamt()));
		objCancelTransferForm.setCancelTransTransferDate (ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getRequested_exe_dt()));
		objCancelTransferForm.setCancelTransDollarsTransfered (ConvertionUtil.convertToString(dsgetCancelPayOutTO.getAccumulatedAmt()));
		...
		objCancelTransferForm.setCancelTransEntryDate(ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getCreated_date()));
		objCancelTransferForm.setPrefered_previous_txn_dt(ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getPrefered_previous_txn_dt()));
		objCancelTransferForm.setVersionnum(ConvertionUtil.convertToString(dsgetCancelPayOutTO.getVersionnum()));
		objCancelTransferForm.setBatchVersionnum(ConvertionUtil.convertToString(dsgetCancelPayOutTO.getBatversionnum()));
		objCancelTransferForm.setParTxnVersionnum(ConvertionUtil.convertToString(dsgetCancelPayOutTO.getPartxnversionnum()));
		objCancelTransferForm.setTransactiontype(ConvertionUtil.convertToString(dsgetCancelPayOutTO.getTxn_type()));
		objCancelTransferForm.setThreasholdAmount(ConvertionUtil.convertToString(dsgetCancelPayOutTO.getPayfreqlimit()));
		objCancelTransferForm.setParentTxnDate(ConvertionUtil.convertToAppDateStr(dsgetCancelPayOutTO.getPar_txn_request_dt()));
	...
	public CancelTransferConfirmForm cancelTransfer_Recurring_cancelBtn() throws Exception 
	{
		...
		//Service Call.....
		IEBWService objService = EBWServiceFactory.create("cancelRecurringPayment");
		objOutput = objService.execute(clsParamTypes, objParams);
		objCancelTransferConfirmForm.setState("CancelTransferConfirm_INIT");
	...
	/**
	 * Method for CancelTransfer_Recurring State and skipBtn Event. (Skip event execution from the Cancel recurring state )
	 */
