...
public class PaymentDetailsTO implements Serializable 
{
	...
	private String nextpaymentHubTxnId =null; 
	...
	private boolean isTxnRejected = false; //Delegate
	...
	private boolean isCheckVoided =false; //Delegate
	...
	private boolean isTxnFeeRequest = false; //Service..
	...
	private String  preNavigationPage = null;
	...
	//18.Portfolio Loan Account Reference Id..
	...
	/**
	 * @return the isCheckVoided
	 */
	public boolean isCheckVoided() {
		return isCheckVoided;
	}
	/**
	 * @param isCheckVoided the isCheckVoided to set
	 */
	public void setCheckVoided(boolean isCheckVoided) {
		this.isCheckVoided = isCheckVoided;
	}
	/**
	...
	/**
	 * @return the isTxnRejected
	 */
	public boolean isTxnRejected() {
		return isTxnRejected;
	}
	/**
	 * @param isTxnRejected the isTxnRejected to set
	 */
	public void setTxnRejected(boolean isTxnRejected) {
		this.isTxnRejected = isTxnRejected;
	}
	/**
	...
	public String getPreNavigationPage() {
		return preNavigationPage;
	}
	public void setPreNavigationPage(String preNavigationPage) {
		this.preNavigationPage = preNavigationPage;
	}
	/**
	...
	/**
	 * @return the isTxnFeeRequest
	 */
	public boolean isTxnFeeRequest() {
		return isTxnFeeRequest;
	}
	/**
	 * @param isTxnFeeRequest the isTxnFeeRequest to set
	 */
	public void setTxnFeeRequest(boolean isTxnFeeRequest) {
		this.isTxnFeeRequest = isTxnFeeRequest;
	}
	/**
	...
	public String toString()
	{
		...
		retValue = "PaymentDetailsTO ( "
			...
			+ "isTxnRejected = " + this.isTxnRejected + TAB
			...
			+ "isCheckVoided = " + this.isCheckVoided + TAB
			...
			+ "isTxnFeeRequest = " + this.isTxnFeeRequest + TAB
			...
			+ "debitAcntDataInSession = " + this.debitAcntDataInSession + TAB
			+ "creditAcntDataInSession = " + this.creditAcntDataInSession + TAB
			...
			+ "otherAcntOwner = " + this.otherAcntOwner + TAB
			...
			+ "preNavigationPage = " + this.preNavigationPage + TAB
			...
			+ "loanAcntNo = " + this.loanAcntNo + TAB
			+ " )";
