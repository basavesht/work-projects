/*
 * Created on Wed Jun 03 16:06:04 IST 2009
 *
 ...
 * **********************************************************
 */
public class TrxnDetailsForm extends EbwForm implements java.io.Serializable {

	/**
	 * Form Bean Constructor. 
	 */ 
	public TrxnDetailsForm () 
	{
		try 
		{
			setState("TrxnDetails_INIT");
	...
	public void copyCollections(TrxnDetailsForm srcForm) {
	}
	...
	private String recuringActiveFlg = null;
	private String currentDatedFlg = null;
	...
	private String txnSettlememtFlg = null;
	...
	public void loadReasonCodesConfiguration() {
		...
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.reasonCodes.reasonCodesSelectId.Select\" />");
		...
		tableColAttr.setTagContent("<input type=\"radio\" name=\"reasonCodesSelectId\" id=\"reasonCodesSelectId~VARIABLE\" value= \"~VARIABLE\" ><label for=\"reasonCodesSelectId\" ><ebwbean:message key=\"TrxnDetails.reasonCodes.reasonCodesSelectId.Select\" /></label>");
		...
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.reasonCodes.REASONCODEDATE\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.reasonCodes.REASONCODETIME\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.reasonCodes.REASONCODEDESC\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
	...
	public void loadActionDetailsConfiguration() {
		...
		tableColAttr.setComponentType("RadioButton");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.actionDetailsSelectId.Select\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		tableColAttr.setTagContent("<input type=\"radio\" name=\"actionDetailsSelectId\" id=\"actionDetailsSelectId~VARIABLE\" value= \"~VARIABLE\" ><label for=\"actionDetailsSelectId\" ><ebwbean:message key=\"TrxnDetails.actionDetails.actionDetailsSelectId.Select\" /></label>");
		arrTableCols.add(tableColAttr);
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.DEPT\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.ACTION\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.LOGINID\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.USERNAME\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.ACTIONDATE\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.STATUS\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.actionDetails.COMMENTS\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
	...
	public void loadAuthDetailsConfiguration() 
	{
		...
		tableColAttr.setComponentType("RadioButton");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.authDetailsSelectId.Select\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		tableColAttr.setTagContent("<input type=\"radio\" name=\"authDetailsSelectId\" id=\"authDetailsSelectId~VARIABLE\" value= \"~VARIABLE\" ><label for=\"authDetailsSelectId\" ><ebwbean:message key=\"TrxnDetails.authDetails.authDetailsSelectId.Select\" /></label>");
		arrTableCols.add(tableColAttr);
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.INFORECEIVER\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.SPOKETO\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.AUTHDATE\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.AUTHTIME\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.CLIENTVERIFICATION\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.COMFIRMEDBY\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.authDetails.AUTHUSERNAME\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
	...
	public void loadSignedAuthDetailsConfiguration() 
	{
		...
		tableColAttr.setComponentType("RadioButton");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.signedAuthDetails.signedAuthDetailsSelectId.Select\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		tableColAttr.setTagContent("<input type=\"radio\" name=\"signedAuthDetailsSelectId\" id=\"signedAuthDetailsSelectId~VARIABLE\" value= \"~VARIABLE\" ><label for=\"signedAuthDetailsSelectId\" ><ebwbean:message key=\"TrxnDetails.signedAuthDetails.signedAuthDetailsSelectId.Select\" /></label>");
		arrTableCols.add(tableColAttr);
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.signedAuthDetails.SPOKETO\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.signedAuthDetails.COMFIRMEDBY\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
		...
		tableColAttr.setComponentType("LabelData");
		tableColAttr.setDataType("Varchar");
		tableColAttr.setDisplayLabel("<ebwbean:message key=\"TrxnDetails.signedAuthDetails.AUTHUSERNAME\" />");
		tableColAttr.setFieldAttribute("");
		tableColAttr.setDefaultValue("~VARIABLE");
		tableColAttr.setDynamicValue("");
		tableColAttr.setDisplayLength("");
	...
	/**
	 * @return the recuringActiveFlg
	 */
	public String getRecuringActiveFlg() {
		return recuringActiveFlg;
	}
	/**
	 * @param recuringActiveFlg the recuringActiveFlg to set
	 */
	public void setRecuringActiveFlg(String recuringActiveFlg) {
		this.recuringActiveFlg = recuringActiveFlg;
	}
	/**
	 * @return the currentDatedFlg
	 */
	public String getCurrentDatedFlg() {
		return currentDatedFlg;
	}
	/**
	 * @param currentDatedFlg the currentDatedFlg to set
	 */
	public void setCurrentDatedFlg(String currentDatedFlg) {
		this.currentDatedFlg = currentDatedFlg;
	}
	/**
	...
	public Vector getReportInformation(){
		...
		Object[][] objArr = {{"TrxnDetails", "ScreenName"}};
	...
	/**
	 * @return the txnSettlememtFlg
	 */
	public String getTxnSettlememtFlg() {
		return txnSettlememtFlg;
	}
	/**
	 * @param txnSettlememtFlg the txnSettlememtFlg to set
	 */
	public void setTxnSettlememtFlg(String txnSettlememtFlg) {
		this.txnSettlememtFlg = txnSettlememtFlg;
	}
	/**
	...
	public String toString()
	{
		...
		retValue = "TrxnDetailsForm ( "
			...
			+ "statusHidden = " + this.statusHidden + TAB
			...
			+ "signedAuthDetailsSelectId = " + this.signedAuthDetailsSelectId + TAB
			+ "signedAuthDetailsCollection = " + this.signedAuthDetailsCollection + TAB
			+ "signedAuthDetailsFilHide = " + this.signedAuthDetailsFilHide + TAB
			+ "auth_mode = " + this.auth_mode + TAB
			+ "recurringFlag = " + this.recurringFlag + TAB
			+ "recuringActiveFlg = " + this.recuringActiveFlg + TAB
			+ "currentDatedFlg = " + this.currentDatedFlg + TAB
			...
			+ "printMode = " + this.printMode + TAB
			+ "retirement_mnemonic = " + this.retirement_mnemonic + TAB
			+ "txnSettlememtFlg = " + this.txnSettlememtFlg + TAB
