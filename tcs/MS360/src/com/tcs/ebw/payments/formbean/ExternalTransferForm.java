...
public class ExternalTransferForm extends EbwForm implements java.io.Serializable {
	...
	public void populateCollections() throws Exception{
		...
		if(this.transferTypeIRACollection==null)
			FetchTransferTypeIRACollection();
	...
	public void copyCollections(ExternalTransferForm srcForm) {
		...
		this.transferTypeIRACollection=srcForm.getTransferTypeIRACollection();
	...
	private String transferTypeIRAEdit= null;
	private Collection frequencycomboCollection;
	private Collection transferTypeIRACollection;
	...
	/**
	 * Set collection for the TransferType IRA combobox.
	 * @param frequencycomboCollection
	 */
	public void setTransferTypeIRACollection(Collection transferTypeIRACollection) {
		this.transferTypeIRACollection=transferTypeIRACollection;
	}

	/**
	 * Get collection for the TransferType IRA combobox.
	 * @return frequencycomboCollection
	 */
	public Collection getTransferTypeIRACollection() {
		return this.transferTypeIRACollection;
	}

	public void FetchTransferTypeIRACollection() throws Exception{
		try{
			if (this.transferTypeIRACollection == null) {
				ComboboxData cboData = new ComboboxData();
				this.transferTypeIRACollection = cboData.getComboBoxData("","","","");
			}
		}catch (EbwException exc) {
			exc.printStackTrace();
			throw exc;
	...
	/**
	 * @return the transferTypeIRAEdit
	 */
	public String getTransferTypeIRAEdit() {
		return transferTypeIRAEdit;
	}

	/**
	 * @param transferTypeIRAEdit the transferTypeIRAEdit to set
	 */
	public void setTransferTypeIRAEdit(String transferTypeIRAEdit) {
		this.transferTypeIRAEdit = transferTypeIRAEdit;
	}
