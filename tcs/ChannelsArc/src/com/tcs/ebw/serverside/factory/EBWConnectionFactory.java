...
import com.tcs.ebw.serverside.connections.BancsConnection;
...
import com.tcs.ebw.serverside.connections.HttpServicesConnection;
...
public class EBWConnectionFactory {
	...
	public static IEBWConnection create(String system_type) {
		...
		IEBWConnection connectionObj=null;
			...
			else if(system_type.equalsIgnoreCase(SystemConstants.SYSTEM_TYPE_HTTPSERVICES))
				connectionObj = new HttpServicesConnection();
			...
			else if(system_type.equalsIgnoreCase(SystemConstants.SYSTEM_TYPE_SOCKET))
				connectionObj = new BancsConnection();
			/*else
