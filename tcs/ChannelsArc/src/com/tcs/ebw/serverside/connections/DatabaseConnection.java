...

{
...

	{
		...
		if (performanceLogger.isInfoEnabled()) {
			performanceLogger.info("IP Address : "+getIPAddr()+" - Thread Id : " + Thread.currentThread().getId() + " - " + this.getClass().getName() + " - getDatasourceFromCache(String, String) - Start" ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
		...
		if (performanceLogger.isInfoEnabled()) {
			performanceLogger.info("IP Address : "+getIPAddr()+" - Thread Id : " + Thread.currentThread().getId() + " - " + this.getClass().getName() + " - getDatasourceFromCache(String, String) - End - ElapsedTime : " + elapsedTime); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
		return ds;
