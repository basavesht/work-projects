 ...
 */
public class JNDIContextFactoryNotSpecified extends EbwException{

	public JNDIContextFactoryNotSpecified(String datasource_name) {
        super("SYS0004",datasource_name);
    }
}
