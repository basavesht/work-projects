	...
	public void setCreatePaymentDetailsLog(int statusFlag,String loggingAction,HashMap txnDetails,ServiceContext serviceContext)throws Exception,SQLException 
	{
		...
		try
		{
			...
			if(loggingAction!=null && (loggingAction.equalsIgnoreCase(AuditTrialAction.Approve) || loggingAction.equalsIgnoreCase(AuditTrialAction.Reject))){
				...
				currentTxnLogTO.setCreated_modified_by_emp_id(objPaymentDetails.getMMSystemDesc());
				currentTxnLogTO.setCreated_modified_by_role(objPaymentDetails.getMMSystemDesc());
				currentTxnLogTO.setCreated_modified_by_id(objPaymentDetails.getMMSystemDesc());
				currentTxnLogTO.setPaygroupid(objPaymentDetails.getMMSystemDesc());
			}
