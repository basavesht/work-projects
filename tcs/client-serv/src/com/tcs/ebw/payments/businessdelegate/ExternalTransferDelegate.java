...
public class ExternalTransferDelegate extends EbwBusinessDelegate {
	...
	public ExternalTransferForm externalTransfer_INIT_iNIT() throws Exception 
	{
		...
		IEBWService objService = EBWServiceFactory.create("getOnLoadExtINITDtl",appContext);
		...
		objExternalTransferForm.setBusinessDate(ConvertionUtil.convertToString(dsConfigDetailsOut.getBusiness_date()));
		objExternalTransferForm.setInitiationDate(ConvertionUtil.convertToString(dsConfigDetailsOut.getBusiness_date()));
	...
	public ExternalTransferForm externalTransfer_Edit_iNIT() throws Exception 
	{
		...
		IEBWService objService = EBWServiceFactory.create("getOnLoadExtEditDtl",appContext);
		objOutput = objService.execute(clsParamTypes, objParams);
		...
		objExternalTransferForm.setInitiationDate(ConvertionUtil.convertToString(dsGetEditTransferOutTO.getInitiationDate()));
