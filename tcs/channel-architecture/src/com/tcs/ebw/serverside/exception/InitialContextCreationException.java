 ...
 */
public class InitialContextCreationException extends EbwException {

    
    /**
     * @param arg0
     */
    public InitialContextCreationException(String system_sub_type) {
        super("SYS0006",system_sub_type);
    }
